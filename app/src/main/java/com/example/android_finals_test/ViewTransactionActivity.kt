...
class ViewTransactionActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val processBtn = findViewById<Button>(R.id.processTransactionButton)
        val backBtn = findViewById<Button>(R.id.backButton)
        processBtn.visibility = if(loggedAsAdmin){View.VISIBLE}else{View.GONE}
        //---------------------------------------------------------------------------------//

        //=================================================================================//
        db.collection("account").document(email).collection("currentContracts").document(apartmentID)
            .collection("transaction").get().addOnSuccessListener { result ->
        ...
        processBtn.setOnClickListener {
            val intent = Intent(this, AdminProcessTransactionActivity::class.java)
